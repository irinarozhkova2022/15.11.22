...
Но помимо языка **Markdown** существует огромное количество языков программирования.
И каждый синтаксис языка имеет свою функциональность, подходящий под выполнение задач в каждом конкретном случае.